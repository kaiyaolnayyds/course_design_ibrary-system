...
public class BookManageAdapter extends RecyclerView.Adapter<BookManageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvBookEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (onItemClickListener != null) {
                    onItemClickListener.onItemEditClick(holder.getAdapterPosition(), book);
                }
            }
        });
    }
    ...
    public interface OnItemClickListener {
        ...
        void onItemEditClick(int position, Book book);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvBookName, tvBookAuthor, tvBookDesc, tvBookNum, tvBookDetail, tvBookEdit;
        ...
        public ViewHolder(View itemView) {
            ...
            tvBookEdit = itemView.findViewById(R.id.tv_book_edit);
        }
    }
}
